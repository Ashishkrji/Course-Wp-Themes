(() => {
    var e = {
        3676: () => {
            window.readyState_complete = function(e) {
                ...
                document.addEventListener("readystatechange", (function(n) {
                    return n.target.readyState === "complete" ? typeof e == "function" ? setTimeout((function() {
                        return a(e)
                    })) : "" : ""
                }))
            };
            window.addBodyClass = function(e) {
                var a = new URL(e);
                var n = a.searchParams.get("tab_page");
                var i = a.searchParams.get("edit") && "_edit";
                document.body.classList.add(n);
                document.body.classList.add(n + i)
            };
            window.selectorById = function(e) {
                return document.getElementById(e)
            };
            window.selectorByClass = function(e) {
                return document.getElementsByClassName(e)
            };
            window.json_download = function(e, a) {
                var n = new Blob([e], {
        ...
        4367: () => {
            window.selectSearchField = function(e) {
                var a = document.querySelectorAll(e);
                (function() {
                    a.forEach((function(e) {
                        if (e && !e.classList.contains("tutor-js-form-select") && !e.hasAttribute("noDropdown") && !e.classList.contains("no-tutor-dropdown")) {
                            var a = e.hasAttribute("data-searchable");
                            var t = e.options[e.selectedIndex];
                            e.style.display = "none";
                            var r, o, d, m, c, u, s, l;
                            e.insertAdjacentHTML("afterend", i(e.options, e.value, a));
                            r = e.nextElementSibling;
                            o = r.querySelector(".tutor-form-select-search");
                            d = o && o.querySelector("input");
                            l = r.querySelector(".tutor-form-select-dropdown");
                            var h = r.querySelector(".tutor-form-select-label");
                            h.innerText = t && t.text;
                            r.onclick = function(e) {
                                e.stopPropagation();
                                n(document.querySelectorAll(".tutor-js-form-select"), r);
                            ...
                            n(document.querySelectorAll(".tutor-js-form-select"));
                            c = r.querySelector(".tutor-form-select-options");
                            u = c && c.querySelectorAll(".tutor-form-select-option");
                            if (u) {
                                u.forEach((function(a) {
                                    a.onclick = function(n) {
                                        n.stopPropagation();
                                        var i = Array.from(e.options);
                                        i.forEach((function(i, t) {
                                            if (i.value === n.target.dataset.key) {
                                                var o;
                                                (o = c.querySelector(".is-active")) === null || o === void 0 ? void 0 : o.classList.remove("is-active");
                                                a.classList.add("is-active");
                                                r.classList.remove("is-active");
                                                h.innerText = n.target.innerText;
                                                h.dataset.value = i.value;
                                                e.value = i.value;
                                                var d = document.getElementById("save_tutor_option");
                                                if (d) {
                                                    d.disabled = false
                                                }
                                            }
                            ...
                            if (d) {
                                d.oninput = function(e) {
                                    var a, n = false;
                                    m = e.target.value.toUpperCase();
                                    u.forEach((function(e) {
                                        s = e.querySelector("[tutor-dropdown-item]");
                                        a = s.textContent || s.innerText;
                                        if (a.toUpperCase().indexOf(m) > -1) {
                                            e.style.display = "";
                                            n = "false"
                                        } else {
                                            n = "true";
                                    ...
                                    var t = l.querySelector(".tutor-form-select-options");
                                    if (0 == p(u)) {
                                        var r = false;
                                        t.querySelectorAll(".tutor-form-select-option").forEach((function(e) {
                                            if (e.classList.contains("noItem") == true) {
                                                r = true
                                            }
                                        }));
                                        if (false == r) {
                                        ...
                                        if (null !== l.querySelector(".noItem")) {
                                            l.querySelector(".noItem").remove()
                                        }
                                    }
                                }
                            }
                    ...
                    e.forEach((function(e) {
                        if (e.nextElementSibling) {
                            if (e.nextElementSibling.classList.contains("tutor-js-form-select")) {
        ...
        1103: () => {
            window.jQuery(document).ready((function(e) {
                e("div.tutor-lesson-wrapper [data-mce-style]").each((function() {
                    e(this).attr("style", e(this).attr("data-mce-style"));
                    e(this).removeAttr("data-mce-style")
                }));
                e(document).on("click", '.tutor-single-course-lesson-comments button[type="submit"]', (function(a) {
                    a.preventDefault();
                    var n = wp.i18n.__;
                    var i = e(this);
                    var t = i.closest("form");
                    var r = t.serialize();
                    var o = t.find('textarea[name="comment"]').val();
                    if (o.trim().length === 0) {
                        tutor_toast(n("Warning", "tutor"), n("Blank comment is not allowed.", "tutor"), "error");
                        return
                    }
                    e.ajax({
                        ...
                        beforeSend: function e() {
                            i.addClass("is-loading").prop("disabled", true)
                        },
                        complete: function e() {
                        ...
                        success: function a(n) {
                            var i = t.attr("tutor-comment-reply");
                            if (typeof i !== "undefined" && i !== false) {
                                t.before(n.data.html)
                            } else {
                                var r = document.querySelector(".tutor-course-spotlight-comments");
                                r.innerHTML = n.data.html
                            }
                            e(".tutor-comment-line").css("height", "calc(100% - 308px)");
                            e("textarea").val("")
                        },
                        error: function e(a) {
                            i.removeClass("is-loading").prop("disabled", false)
                        }
                    })
                }))
            }))
        ...
        818: () => {
            window.jQuery(document).ready((function(e) {
                if (e.fn.ShareLink) {
                    var a = e(".tutor-social-share-wrap");
                    if (a.length) {
                        var n = JSON.parse(a.attr("data-social-share-config"));
                        a.find(".tutor_share").ShareLink({
                            title: n.title,
                            text: n.text,
                            image: n.image,
                            class_prefix: "s_",
        ...
        6470: () => {
            window.jQuery(document).ready((function(e) {
                ...
                if (e(".tutor-quiz-wrap").length) {
                    if (!e(".tutor-table-quiz-attempts").length && !e(".tutor-quiz-attempt-details").length) {
                        e(".tutor-course-topic-single-footer").remove()
                    }
                }
                var n = e("#tutor-quiz-time-update");
                if (n.length) {
                    var i = JSON.parse(n.attr("data-attempt-settings"));
                    var t = JSON.parse(n.attr("data-attempt-meta"));
                    if (t.time_limit.time_limit_seconds > 0) {
                        var r, o;
                        var d = new Date((r = i.attempt_started_at) === null || r === void 0 ? void 0 : r.replaceAll("-", "/")).getTime() + t.time_limit.time_limit_seconds * 1e3;
                        var m = new Date((o = t.date_time_now) === null || o === void 0 ? void 0 : o.replaceAll("-", "/")).getTime();
                        var c = setInterval((function() {
                            var i = d - m;
                            var r = Math.floor(i / (1e3 * 60 * 60 * 24));
                            var o = Math.floor(i % (1e3 * 60 * 60 * 24) / (1e3 * 60 * 60));
                            var u = Math.floor(i % (1e3 * 60 * 60) / (1e3 * 60));
                            var s = Math.floor(i % (1e3 * 60) / 1e3);
                            var l = "";
                            r ? l += r + "d " : 0;
                            l += (o || 0) + "h ";
                            l += (u || 0) + "m ";
                            ...
                            if (i < 0) {
                                clearInterval(c);
                                n.toggleClass("tutor-quiz-time-expired");
                                l = "EXPIRED";
                                if (_tutorobject.quiz_options.quiz_when_time_expires === "auto_submit") {
                                    e("form#tutor-answering-quiz").submit()
                                } else {
                                    e(".tutor-quiz-answer-next-btn, .tutor-quiz-submit-btn, .tutor-quiz-answer-previous-btn").prop("disabled", true);
                                    e("button[name='quiz_answer_submit_btn']").prop("disabled", true);
                                    e(".time-remaining span").css("color", "#F44337");
                                    e.ajax({
                                        url: _tutorobject.ajaxurl,
                                        type: "POST",
                                        data: {
                                            quiz_id: e("#tutor_quiz_id").val(),
                                            action: "tutor_quiz_timeout"
                                        },
                                        success: function i(t) {
                                            var r = e("#tutor-quiz-time-expire-wrapper").data("attempt-allowed");
                                            var o = e("#tutor-quiz-time-expire-wrapper").data("attempt-remaining");
                                            var d = "#tutor-quiz-time-expire-wrapper";
                                            e(d).addClass("tutor-alert-show");
                                            if (o > 0) {
                                                e("".concat(d, " .tutor-quiz-alert-text")).html(a("Your time limit for this quiz has expired, please reattempt the quiz. Attempts remaining:", "tutor") + " " + o + "/" + r)
                                            } else {
                                                if (e(d).hasClass("time-remaining-warning")) {
                                                    e(d).removeClass("time-remaining-warning");
                                                    e(d).addClass("time-over")
                                                }
                                                if (e("".concat(d, " .flash-info span:first-child")).hasClass("tutor-icon-circle-info")) {
                                                    e("".concat(d, " .flash-info span:first-child")).removeClass("tutor-icon-circle-info");
                                                    e("".concat(d, " .flash-info span:first-child")).addClass("tutor-icon-circle-times-line")
                                                }
                                                n.toggleClass("tutor-quiz-time-expired");
                                                e("#tutor-start-quiz").hide();
                                                e("".concat(d, " .tutor-quiz-alert-text")).html("".concat(a("Unfortunately, you are out of time and quiz attempts. ", "tutor")));
                            ...
                            n.html(l);
                            if (l == "EXPIRED") {
                                n.addClass("color-text-error")
                            }
                            if (i) {
                                var h = i / 1e3;
                                var p = t.time_limit.time_limit_seconds;
                                var y = Math.ceil(h * 100 / p);
                                var f = document.querySelector(".quiz-time-remaining-progress-circle");
                                var v = document.querySelector(".quiz-time-remaining-progress-circle svg");
                                if (v && f) {
                                    var g = 44 - 44 * (y / 100);
                                    if (y <= 0) {
                                        y = 0;
                                        f.innerHTML = '<svg viewBox="0 0 50 50" width="50" height="50">\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t<circle cx="0" cy="0" r="11"></circle>\n\t\t\t\t\t\t\t\t\t\t\t\t\t</svg>';
                                        f.setAttribute("class", "quiz-time-remaining-expired-circle")
                                    }
                                    v.setAttribute("style", "stroke-dashoffset: ".concat(g, ";"))
                                }
                            }
                        }), 1e3)
                    } else {
                        n.html(a("No Limit", "tutor"))
                    }
                }
                var u = e("form#tutor-start-quiz");
                if (u.length) {
        ...
        3419: () => {
            window.jQuery(document).ready((function(e) {
                var a = window.wp.i18n.__;
                var n = _tutorobject.quiz_options;
                var i = new Map;
                e(".tutor-sortable-list").on("sortchange", t);

                function t(a, n) {
                    var t = parseInt(e(this).closest(".quiz-attempt-single-question").attr("id").match(/\d+/)[0], 10);
                    if (!i.get(t)) {
                        i.set(t, true)
                    }
                }
                ...
                function c(n) {
                    var i = false;
                    var t = JSON.parse(window.tutor_quiz_context.split("").reverse().join(""));
                    !Array.isArray(t) ? t = [] : 0;
                    if (d() !== "question_below_each_other") {
                        e(".tutor-quiz-answer-single-info").remove()
                    }
                    e(".tutor-quiz-answer-single").removeClass("tutor-quiz-answer-single-correct tutor-quiz-answer-single-incorrect");
                    var r = true;
                    var c = n.find("input");
                    var u = n.find('input[type="radio"]:checked, input[type="checkbox"]:checked');
                    if (o()) {
                        u.each((function() {
                            var a = e(this);
                            var n = t.indexOf(a.val()) > -1;
                            if (!n) {
                                r = false
                            }
                        }));
                        c.each((function() {
                            ...
                            if (o === "radio" || o === "checkbox") {
                                var d = t.indexOf(n.val()) > -1;
                                var c = n.is(":checked");
                                if (d) {
                                    n.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-correct").append(m(a("Correct Answer", "tutor"))).find(".tutor-quiz-answer-single-info:eq(1)").remove()
                                } else {
                                    if (n.prop("checked")) {
                ...
                function u(a) {
                    var n = true;
                    var i = a[0];
                    var t = e(i).find(".tutor-dropzone");
                    if (t.length > 0) {
                        Object.values(t).forEach((function(a) {
                            if (a instanceof Element && a.classList.contains("tutor-dropzone")) {
                                if (e(a).has("input").length === 0) {
                                    n = false
                                }
                            }
                        }))
                ...
                function s(n, t) {
                    var r = n.find(".quiz-answer-required");
                    if (r.length) {
                        var o = parseInt(n.attr("id").match(/\d+/)[0], 10);
                        var d = i.get(o);
                        var m = n.find(".tutor-draggable");
                        var c = n.find(".ui-sortable");
                        var s = r.find("input");
                        if (s.length) {
                            var l = s.attr("type");
                            if (l === "radio") {
                                if (r.find('input[type="radio"]:checked').length == 0) {
                                    n.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(a("Please select an option to answer", "tutor"), "</p>"));
                                    t = false
                                }
                            } else if (l === "checkbox") {
                                if (r.find('input[type="checkbox"]:checked').length == 0) {
                                    n.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(a("Please select at least one option to answer.", "tutor"), "</p>"));
                                    t = false
                                }
                            } else if (l === "text") {
                                s.each((function(i, r) {
                                    if (!e(r).val().trim().length) {
                                        n.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(a("The answer for this question is required", "tutor"), "</p>"));
                                        t = false
                                    }
                                }))
                            }
                        }
                        if (r.find("textarea").length) {
                            if (r.find("textarea").val().trim().length < 1) {
                                n.find(".answer-help-block").html('<p style="color: #dc3545">'.concat(a("The answer for this question is required", "tutor"), "</p>"));
                                t = false
                            }
                        }
                ...
                e(".tutor-quiz-next-btn-all").prop("disabled", false);
                e(".quiz-attempt-single-question input").filter('[type="radio"], [type="checkbox"]').change((function() {
                    e(".tutor-quiz-next-btn-all").prop("disabled", false)
                }));
                e(document).on("click", ".tutor-quiz-answer-next-btn, .tutor-quiz-answer-previous-btn", (function(a) {
                    a.preventDefault();
                    var n = e(".tutor-quiz-question-counter>span:first-child");
                    var i = parseInt(e(this).closest("[data-question_index]").data("question_index"));
                    if (e(this).hasClass("tutor-quiz-answer-previous-btn")) {
                        e(this).closest(".quiz-attempt-single-question").hide().prev().show();
                        n.text(i - 1);
                        return
                    }
                    var t = e(this);
                    var d = t.closest(".quiz-attempt-single-question");
                    var m = parseInt(t.closest(".quiz-attempt-single-question").attr("id").match(/\d+/)[0], 10);
                    var u = t.closest(".quiz-attempt-single-question").attr("data-next-question-id");
                    var l = true;
                    l = s(d, l);
                    if (!l) {
                        return
                    ...
                    if (u) {
                        ...
                        if (p && p.length) {
                            if (o()) {
                                setTimeout((function() {
                                    e(".quiz-attempt-single-question").hide();
                                    p.show()
                                }), r())
                            } else {
                                e(".quiz-attempt-single-question").hide();
                            ...
                            if (e(".tutor-quiz-questions-pagination").length) {
                                e(".tutor-quiz-question-paginate-item").removeClass("active");
                                e('.tutor-quiz-questions-pagination a[href="' + u + '"]').addClass("active")
                            }
                            n.text(i + 1)
                        }
                    }
                }));
                e(document).on("click", ".tutor-quiz-question-paginate-item", (function(a) {
                    a.preventDefault();
                    var n = e(this);
                    var i = e(n.attr("href"));
                    e(".quiz-attempt-single-question").hide();
                ...
                e(document).on("keyup", "textarea.question_type_short_answer, textarea.question_type_open_ended", (function(a) {
                    var n = e(this);
                    var i = n.val();
                    var t = n.hasClass("question_type_short_answer") ? _tutorobject.quiz_options.short_answer_characters_limit : _tutorobject.quiz_options.open_ended_answer_characters_limit;
                    var r = t - i.length;
                    if (r < 1) {
                        n.val(i.substr(0, t));
                        r = 0
                    }
                    n.closest(".quiz-attempt-single-question").find(".characters_remaining").html(r)
                }));
                e(document).on("submit", "#tutor-answering-quiz", (function(a) {
                    a.preventDefault();
                    var n = e(".quiz-attempt-single-question");
                    var i = document.querySelector(".tutor-quiz-submit-btn");
                    var t = e(a.target);
                    var m = true;
                    var u = true;
                    if (n.length) {
                    ...
                    if (_tutorobject.quiz_options.quiz_when_time_expires === "auto_submit" && e("#tutor-quiz-time-update").hasClass("tutor-quiz-time-expired")) {
                        m = true;
                        u = true
                    }
                    if (m && u) {
                        var l = 500;
                        if (o() && d() === "question_below_each_other") {
                            l = r();
                            t.find(":submit").addClass("is-loading").attr("disabled", "disabled")
                        }
                        setTimeout((function() {
                            a.target.submit()
                        }), l)
                ...
                e(".tutor-quiz-submit-btn").click((function(a) {
                    var n = this;
                    a.preventDefault();
                    if (o()) {
                        var i = e(".quiz-attempt-single-question");
                        var t = true;
                        if (i.length) {
                            i.each((function(a, n) {
                                t = s(e(n));
                        ...
                        setTimeout((function() {
                            e(n).addClass("is-loading");
                            e("#tutor-answering-quiz").submit()
                        }), r())
                    } else {
                        e(this).attr("disabled", "disabled").addClass("is-loading");
                        e("#tutor-answering-quiz").submit()
                    }
                }));
                var l = e("#tutor-quiz-time-update");
                e(document).on("click", "a", (function(n) {
                    if (n.target.classList.contains("sidebar-ask-new-qna-btn") || n.target.classList.contains("tutor-quiz-question-paginate-item")) {
                        return
                    }
                    if (l.length > 0 && l.text() != "EXPIRED") {
                        n.preventDefault();
                        n.stopImmediatePropagation();
                        var i;
                        var t = {
                            title: a("Abandon Quiz?", "tutor"),
                            description: a("Do you want to abandon this quiz? The quiz will be submitted partially up to this question if you leave this page.", "tutor"),
                            buttons: {
                                keep: {
                                    title: a("Yes, leave quiz", "tutor"),
                                    id: "leave",
                                    class: "tutor-btn tutor-btn-outline-primary",
                                    callback: function n() {
                                        var t = e("form#tutor-answering-quiz").serialize() + "&action=" + "tutor_quiz_abandon";
                                        e.ajax({
                                            url: window._tutorobject.ajaxurl,
                                            type: "POST",
                                            data: t,
                                            beforeSend: function e() {
                                                document.querySelector("#tutor-popup-leave").innerHTML = a("Leaving...", "tutor")
                                            },
                                            success: function e(n) {
                                                if (n.success) {
                                                    location.reload(true)
                                                } else {
                                                    alert(a("Something went wrong", "tutor"))
                                                }
                                            },
                                            error: function e() {
                                                alert(a("Something went wrong", "tutor"));
                                                i.find("[data-tutor-modal-close]").click()
                                            }
                                        })
                                    }
                                },
                                reset: {
                                    title: a("Stay here", "tutor"),
                                    id: "reset",
                        ...
                        i = new window.tutor_popup(e, "").popup(t)
                    }
                }));
                e("body").on("submit", "form#tutor-start-quiz", (function() {
                    e(this).find("button").prop("disabled", true)
                }))
            }))
        },
        7942: () => {
            window.jQuery(document).ready((function(e) {
                var a = wp.i18n.__;
                e(document).on("click", ".tutor-course-wishlist-btn", (function(a) {
                    a.preventDefault();
                    var n = e(this);
                    var i = n.attr("data-course-id");
                    e.ajax({
                        url: _tutorobject.ajaxurl,
                        type: "POST",
                        data: {
                        ...
                        beforeSend: function e() {
                            n.attr("disabled", "disabled").addClass("is-loading")
                        },
                        success: function a(i) {
                            if (i.success) {
                                if (i.data.status === "added") {
                                    n.find("i").addClass("tutor-icon-bookmark-bold").removeClass("tutor-icon-bookmark-line")
                                } else {
                                    n.find("i").addClass("tutor-icon-bookmark-line").removeClass("tutor-icon-bookmark-bold")
                                }
                            } else {
                                e(".tutor-login-modal").addClass("tutor-is-active")
                            }
                        },
                        complete: function e() {
                            n.removeAttr("disabled").removeClass("is-loading")
                        }
                    })
                }))
            }))
        ...
        7723: () => {
            window.jQuery(document).ready((function(e) {
                e(document).on("added_to_cart", (function(e, a, n, i) {
                    i.removeClass("is-loading");
                    i.siblings("a.added_to_cart").addClass("tutor-btn tutor-btn-outline-primary tutor-btn-md tutor-btn-block").prepend('<span class="tutor-icon-cart-line tutor-mr-8"></span>')
                }));
                e(document).on("adding_to_cart", (function(e, a) {
        ...
        1626: () => {
            function e(e, n) {
                ...
                if (!i) {
                    if (Array.isArray(e) || (i = a(e)) || n && e && typeof e.length === "number") {
                        if (i) e = i;
                        var t = 0;
                        var r = function e() {};
                        return {
            ...
            function a(e, a) {
                ...
                if (i === "Map" || i === "Set") return Array.from(e);
                if (i === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i)) return n(e, a)
            }
            ...
            document.addEventListener("DOMContentLoaded", (function() {
                var a = wp.i18n,
                    ...
                    t = a._n,
                    r = a._nx;
                var o = document.querySelectorAll(".tutor-export-purchase-history");
                var d = e(o),
                    m;
                try {
                    for (d.s(); !(m = d.n()).done;) {
                        ...
                        if (c) {
                            c.onclick = function(e) {
                                ...
                                var n = "order-".concat(a.dataset.order, "-purchase-history.csv");
                                var i = [{
                                    "Order ID ": a.dataset.order,
                                    "Course Name": a.dataset.courseName,
        ...
        6966: () => {
            document.addEventListener("DOMContentLoaded", (function() {
                ...
                e(".tutor-dashboard .tutor-dashboard-menu-toggler").click((function() {
                    var a = e(".tutor-dashboard-left-menu");
                    a.closest(".tutor-dashboard").toggleClass("is-sidebar-expanded");
        ...
        6344: (e, a, n) => {
            var i = n(3632),
                t = i.get_response_message;
            window.jQuery(document).ready((function(e) {
                e('.tutor-settings-pass-field [name="confirm_new_password"]').on("input", (function() {
                    var a = e('[name="new_password"]');
                    var n = (a.val() || "").trim();
                    var i = n && e(this).val() === n;
                    e(this).parent().find(".tutor-validation-icon")[i ? "show" : "hide"]()
                }));
                e(".tutor-profile-password-reset").click((function(a) {
                    a.preventDefault();
                    var n = e(this);
                    var i = n.closest("form");
                    var r = i.serializeObject();
                    r.action = "tutor_profile_password_reset";
                    e.ajax({
                        url: _tutorobject.ajaxurl,
                        type: "POST",
                        data: r,
                        ...
                        success: function e(a) {
                            var e = a.success;
                            if (e) {
                                window.tutor_toast("Success", t(a), "success");
                                window.location.reload()
                            } else {
                                window.tutor_toast("Error", t(a), "error")
                            }
                        },
                        complete: function e() {
        ...
        1974: (e, a, n) => {
            ...
            var o = function e(a, n, i) {
                ...
                t.addEventListener("load", (function() {
                    ...
                    e.addEventListener("load", (function() {
                        ...
                        n.height = n.height || r / t * n.width;
                        var u = n.width > t ? t : n.width;
                        var s = n.width > t ? r : n.height;
                        var l = document.createElement("canvas");
                        l.width = u;
                        l.height = s;
                        var h = l.getContext("2d");
                        h.drawImage(e, o, d, m, c, 0, 0, l.width, l.height);
                        l.toBlob((function(e) {
                            e.name = a.name;
            ...
            window.jQuery(document).ready((function(e) {
                var a = wp.i18n.__;
                var n = function n(i) {
                    this.dialogue_box = i.find("#tutor_photo_dialogue_box");
                    this.open_dialogue_box = function(e) {
                        this.dialogue_box.attr("name", e);
                        this.dialogue_box.trigger("click")
                    };
                    this.upload_selected_image = function(n, i) {
                        var t = tutor_get_nonce_data(true);
                        var r = this;
                        r.toggle_loader(n, true);
                        var o = new FormData;
                        o.append("action", "tutor_user_photo_upload");
                        o.append("photo_type", n);
                        o.append("photo_file", i, i.name);
                        o.append(t.key, t.value);
                        var d = this;
                        e.ajax({
                            url: window._tutorobject.ajaxurl,
                            data: o,
                            ...
                            error: r.error_alert,
                            success: function e() {
                                var i = d.title_capitalize(n.replace("_", " "));
                                var t = a("Success", "tutor");
                                var r = i + " Changed Successfully!";
                                if ("Profile Photo" === i) {
                                    r = a("Profile Photo Changed Successfully!", "tutor")
                                }
                                if ("Cover Photo" === i) {
                                    r = a("Cover Photo Changed Successfully!", "tutor")
                                }
                                tutor_toast(t, r, "success")
                            },
                            complete: function e() {
                                r.toggle_loader(n, false)
                            }
                        })
                    };
                    this.title_capitalize = function(e) {
                        var a = e.split(" ");
                        for (var n = 0; n < a.length; n++) {
                            a[n] = a[n].charAt(0).toUpperCase() + a[n].slice(1)
                        }
                        return a.join(" ")
                    };
                    this.accept_upload_image = function(a, n) {
                        var i = n.currentTarget.files[0] || null;
                        a.update_preview(n.currentTarget.name, i);
                        o(i, {
                            width: 1200
                        }, (function(e) {
                            a.upload_selected_image(n.currentTarget.name, e)
                        }));
                        e(n.currentTarget).val("")
                    };
                    this.delete_image = function(a) {
                        var n = this;
                        n.toggle_loader(a, true);
                        e.ajax({
                            url: window._tutorobject.ajaxurl,
                            data: {
                            ...
                            error: n.error_alert,
                            complete: function e() {
                                n.toggle_loader(a, false)
                            }
                        })
                    };
                    this.update_preview = function(e, a) {
                        var n = i.find(e == "cover_photo" ? "#tutor_cover_area" : "#tutor_profile_area");
                        if (!a) {
                            n.css("background-image", "url(" + n.data("fallback") + ")");
                            this.delete_image(e);
                            return
                        }
                        var t = new FileReader;
                        t.onload = function(e) {
                            n.css("background-image", "url(" + e.target.result + ")")
                        };
                        t.readAsDataURL(a)
                    };
                    this.toggle_profile_pic_action = function(e) {
                        var a = e === undefined ? "toggleClass" : e ? "addClass" : "removeClass";
                        i[a]("pop-up-opened")
                    };
                    this.error_alert = function() {
                        tutor_toast("Error", "Maximum file size exceeded!", "error")
                    };
                    this.toggle_loader = function(e, a) {
                        i.find("#tutor_photo_meta_area .loader-area").css("display", a ? "block" : "none")
                    };
                    this.initialize = function() {
                        var e = this;
                        this.dialogue_box.change((function(a) {
                            e.accept_upload_image(e, a)
                        }));
                        i.find("#tutor_profile_area .tutor_overlay, #tutor_pp_option>div:last-child").click((function() {
                            e.toggle_profile_pic_action()
                        }));
                        i.find(".tutor_cover_uploader").click((function() {
                            e.open_dialogue_box("cover_photo")
                        }));
                        i.find(".tutor_pp_uploader").click((function() {
                            e.open_dialogue_box("profile_photo")
                        }));
                        i.find(".tutor_cover_deleter").click((function() {
                            e.update_preview("cover_photo", null)
                        }));
                        i.find(".tutor_pp_deleter").click((function() {
                            e.update_preview("profile_photo", null)
                        }))
                    }
                };
                var i = e("#tutor_profile_cover_photo_editor");
                i.length > 0 ? new n(i).initialize() : 0;
                e(".tutor-profile-settings-save").click((function(a) {
                    a.preventDefault();
                    var n = e(this);
                    var i = n.closest("form");
                    var r = i.serializeObject();
                    ...
                    if (window.tinyMCE !== undefined) {
                        var d = tinyMCE.get("tutor_profile_bio");
                        r.tutor_profile_bio = d.getContent({
                            format: "html"
                        })
                    }
                    if (r.phone_number && !r.phone_number.match(/^[\+]?[(]?[0-9]{3}[)]?[-\s\.]?[0-9]{3}[-\s\.]?[0-9]{4,6}$/im)) {
                ...
                e("#user_social_form").submit((function(n) {
                    n.preventDefault();
                    var i = e(this).find("button[type=submit]");
                    var r = _tutorobject.ajaxurl;
                    var o = e(this).serializeObject();
                    e.ajax({
                        url: r,
                        type: "POST",
                        data: o,
                        ...
                        success: function e(n) {
                            ...
                            var i = t(n);
                            if (e) {
                                window.tutor_toast(a("Success", "tutor"), i, "success")
                            } else {
                                window.tutor_toast(a("Error", "tutor"), i, "error")
                            }
                        },
                        complete: function e() {
                            i.removeClass("is-loading")
        ...
        787: () => {
            document.addEventListener("DOMContentLoaded", (function() {
                var e = window.jQuery;
                e('.tutor-dashboard-setting-withdraw input[name="tutor_selected_withdraw_method"]').on("change", (function(a) {
                    var n = e(this);
                    var i = n.closest("form");
                    i.find(".withdraw-method-form").hide();
                    i.find(".withdraw-method-form").hide().filter('[data-withdraw-form="' + n.val() + '"]').show()
                }))
            }))
        },
        9834: () => {
            window.jQuery(document).ready((function(e) {
                var a = window.wp.i18n.__;
                e(".tutor-course-retake-button").prop("disabled", false).click((function(n) {
                    n.preventDefault();
                    var i = e(this).attr("href");
                    var t = e(this).data("course_id");
                    var r = {
                        title: a("Override Previous Progress", "tutor"),
                        description: a("Before continue, please decide whether to keep progress or reset.", "tutor"),
                        buttons: {
                            reset: {
                                title: a("Reset Data", "tutor"),
                                ...
                                callback: function n(i) {
                                    e.ajax({
                                        ...
                                        beforeSend: function e() {
                                            i.prop("disabled", true).addClass("is-loading")
                                        },
                                        success: function e(n) {
                                            if (n.success) {
                                                window.location.assign(n.data.redirect_to)
                                            } else {
                                                alert((n.data || {}).message || a("Something went wrong", "tutor"))
                                            }
                                        },
                                        complete: function e() {
                                            i.prop("disabled", false).removeClass("is-loading")
                                        }
                                    })
                                }
                            },
                            keep: {
                                title: a("Keep Data", "tutor"),
                    ...
                    new window.tutor_popup(e, "icon-gear").popup(r)
                }))
            }));
            readyState_complete((function() {
                var e = document.querySelector(".tutor-video-player .loading-spinner");
                if (null !== e) {
                    e.remove()
                }
            }))
        ...
        1033: () => {
            ...
            jQuery(document).ready((function(a) {
                var n = wp.i18n,
                    ...
                    r = n._n,
                    o = n._nx;
                a("[tutor-instructors]").each((function() {
                    var n = a(this);
                    var i = {};
                    var t;
                    var r = document.querySelector(".tutor-ratings-stars i.is-active");
                    var o = 0;
                    if (r) {
                        o = r.dataset.value
                    }
                    ...
                    function d(e, t, r) {
                        var o = n.find("[tutor-instructors-content]");
                        var d = o.html();
                        var m = n.data();
                        m.current_page = r || 1;
                        e ? i[e] = t : i = {};
                        i.attributes = m;
                        i.action = "load_filtered_instructor";
                        o.html('<div class="tutor-spinner-wrap"><span class="tutor-spinner" area-hidden="true"></span></div>');
                        a.ajax({
                            url: window._tutorobject.ajaxurl,
                            data: i,
                            type: "POST",
                    ...
                    n.on("change", '[tutor-instructors-filter-category] [type="checkbox"]', (function() {
                        var e = {};
                        a(this).closest("[tutor-instructors-filter-category]").find("input:checked").each((function() {
                            e[a(this).val()] = a(this).parent().text()
                        }));
                        var n = Object.keys(e);
                        d(a(this).attr("name"), n)
                    })).on("click", "[tutor-instructors-filter-rating]", (function(e) {
                        var a = e.target.dataset.value;
                        if (a != o) {
                            d("rating_filter", a)
                        }
                        o = a
                        ...
                        e.preventDefault();
                        d(null, null, a(this).data("page_number"))
                    })).on("click", "[tutor-instructors-filter-clear]", (function() {
                        var n = a(this).closest("[tutor-instructors-filters]");
                        n.find('input[type="checkbox"]').prop("checked", false);
                        n.find("[tutor-instructors-filter-search]").val("");
                        var i = document.querySelectorAll("[tutor-instructors-filter-rating]");
                        var t = e(i),
                            r;
                        try {
                            for (t.s(); !(r = t.n()).done;) {
                ...
                var d = document.querySelectorAll("[tutor-instructors-filter-rating]");
                var m = document.querySelector("[tutor-instructors-filter-rating-count]");
                var c = e(d),
                    u;
                try {
                    for (c.s(); !(u = c.n()).done;) {
                        ...
                        s.onclick = function(a) {
                            ...
                            var c = Number(a.target.dataset.value);
                            var u = i("star", "tutor");
                            if (c > 1) {
                                u = i("stars", "tutor")
                            }
                            ...
                            if (!n.classList.contains("tutor-icon-star-bold")) {
                                n.classList.remove("tutor-icon-star-line");
                                n.classList.add("tutor-icon-star-bold")
                            }
                            m.innerHTML = "".concat(c, " ").concat(u)
                        }
                    }
                } catch (e) {
                    c.e(e)
        ...
        3632: (e, a, n) => {
            ...
            n.r(a);
            n.d(a, {
                get_response_message: () => i
            });
            var i = function e(a, n) {
                var i = wp.i18n.__;
                var t = a || {},
                    r = t.data,
                    o = r === void 0 ? {} : r;
                var d = o.message,
                    m = d === void 0 ? n || i("Something Went Wrong!", "tutor") : d;
                return m
            }
        }
    };
    ...
    (() => {
        ...
        function i() {
            ...
            var e = {},
                n = Object.prototype,
                t = n.hasOwnProperty,
                r = Object.defineProperty || function(e, a, n) {
                    e[a] = n.value
                },
                o = "function" == typeof Symbol ? Symbol : {},
                d = o.iterator || "@@iterator",
            ...
            function s(e, a, n, i) {
                var t = a && a.prototype instanceof p ? a : p,
            ...
            var g = Object.getPrototypeOf,
                _ = g && g(g(j([])));
            _ && _ !== n && t.call(_, d) && (v = _);
            var b = f.prototype = p.prototype = Object.create(v);
            ...
            function M(e, n) {
                function i(r, o, d, m) {
                    ...
                    if ("throw" !== c.type) {
                        var u = c.arg,
                            s = u.value;
                        return s && "object" == a(s) && t.call(s, "__await") ? n.resolve(s.__await).then((function(e) {
                            i("next", e, d, m)
                        }), (function(e) {
                            i("throw", e, d, m)
            ...
            function D(e, a, n) {
                ...
                return function(t, r) {
                    ...
                    for (n.method = t, n.arg = r;;) {
                        ...
                        var m = l(e, a, n);
                        if ("normal" === m.type) {
                            if (i = n.done ? "completed" : "suspendedYield", m.arg === h) continue;
                            return {
                                value: m.arg,
                                done: n.done
                            }
                        }
                        "throw" === m.type && (i = "completed", n.method = "throw", n.arg = m.arg)
                    }
                }
            }
            ...
            function k(e, a) {
                var n = a.method,
                    i = e.iterator[n];
                if (undefined === i) return a.delegate = null, "throw" === n && e.iterator["return"] && (a.method = "return", a.arg = undefined, k(e, a), "throw" === a.method) || "return" !== n && (a.method = "throw", a.arg = new TypeError("The iterator does not provide a '" + n + "' method")), h;
                var t = l(i, e.iterator, a.arg);
                if ("throw" === t.type) return a.method = "throw", a.arg = t.arg, a.delegate = null, h;
                var r = t.arg;
                return r ? r.done ? (a[e.resultName] = r.value, a.next = e.nextLoc, "return" !== a.method && (a.method = "next", a.arg = undefined), a.delegate = null, h) : r : (a.method = "throw", a.arg = new TypeError("iterator result is not an object"), a.delegate = null, h)
            }
                    ...
                    if (!isNaN(e.length)) {
                        var n = -1,
                            i = function a() {
                                ...
                                return a.value = undefined, a.done = !0, a
                            };
                        return i.next = i
                    }
                }
            ...
            return y.prototype = f, r(b, "constructor", {
                value: f,
                configurable: !0
            }), r(f, "constructor", {
                value: y,
                configurable: !0
            }), y.displayName = u(f, c, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                var a = "function" == typeof e && e.constructor;
                return !!a && (a === y || "GeneratorFunction" === (a.displayName || a.name))
            }, e.mark = function(e) {
            ...
            }, S(M.prototype), u(M.prototype, m, (function() {
                return this
            })), e.AsyncIterator = M, e.async = function(a, n, i, t, r) {
                void 0 === r && (r = Promise);
                var o = new M(s(a, n, i, t), r);
                return e.isGeneratorFunction(n) ? o : o.next().then((function(e) {
                    return e.done ? e.value : o.next()
                }))
            }, S(b), u(b, c, "Generator"), u(b, d, (function() {
                return this
                ...
                var a = Object(e),
                    n = [];
                for (var i in a) n.push(i);
                return n.reverse(),
                    function e() {
                        for (; n.length;) {
                            var i = n.pop();
                            if (i in a) return e.value = i, e.done = !1, e
                        }
                        return e.done = !0, e
                    }
                ...
                constructor: C,
                reset: function e(a) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(w), !a)
                        for (var n in this) "t" === n.charAt(0) && t.call(this, n) && !isNaN(+n.slice(1)) && (this[n] = undefined)
                },
                stop: function e() {
                    this.done = !0;
                ...
                dispatchException: function e(a) {
                    if (this.done) throw a;
                    var n = this;

                    function i(e, i) {
                        return d.type = "throw", d.arg = a, n.next = e, i && (n.method = "next", n.arg = undefined), !!i
                    }
                ...
                abrupt: function e(a, n) {
                    ...
                    o && ("break" === a || "continue" === a) && o.tryLoc <= n && n <= o.finallyLoc && (o = null);
                    var d = o ? o.completion : {};
                    return d.type = a, d.arg = n, o ? (this.method = "next", this.next = o.finallyLoc, h) : this.complete(d)
                },
                complete: function e(a, n) {
                    if ("throw" === a.type) throw a.arg;
                    return "break" === a.type || "continue" === a.type ? this.next = a.arg : "return" === a.type ? (this.rval = this.arg = a.arg, this.method = "return", this.next = "end") : "normal" === a.type && n && (this.next = n), h
                },
                finish: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                        var i = this.tryEntries[n];
                        if (i.finallyLoc === a) return this.complete(i.completion, i.afterLoc), w(i), h
                    }
                },
                catch: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                ...
                delegateYield: function e(a, n, i) {
        ...
        function o(e, a) {
            ...
            if (!n) {
                if (Array.isArray(e) || (n = d(e)) || a && e && typeof e.length === "number") {
                    if (n) e = n;
                    var i = 0;
                    var t = function e() {};
                    return {
        ...
        function d(e, a) {
            if (!e) return;
            if (typeof e === "string") return m(e, a);
            var n = Object.prototype.toString.call(e).slice(8, -1);
            if (n === "Object" && e.constructor) n = e.constructor.name;
            if (n === "Map" || n === "Set") return Array.from(e);
            if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return m(e, a)
        }
        ...
        var c = wp.i18n,
            ...
            h = c._nx;
        document.addEventListener("DOMContentLoaded", (function() {
            var e = document.getElementById("tutor-common-confirmation-modal");
            ...
            var d = document.getElementById("tutor-backend-filter-category");
            if (d) {
            ...
            var m = document.getElementById("tutor-backend-filter-order");
            if (m) {
            ...
            var c = document.getElementById("tutor-backend-filter-payment-status");
            c === null || c === void 0 ? void 0 : c.addEventListener("change", (function(e) {
                window.location = g("payment-status", e.target.value)
            }), {
                once: true
            });
            var s = document.getElementById("tutor-backend-filter-coupon-status");
            s === null || s === void 0 ? void 0 : s.addEventListener("change", (function(e) {
                window.location = g("coupon-status", e.target.value)
            }), {
                once: true
            });
            var l = document.getElementById("tutor-admin-search-filter-form");
            var h = document.getElementById("tutor-backend-filter-search");
            if (l) {
                ...
                l.onsubmit = function(e) {
                    e.preventDefault();
                    var a = h.value;
                    window.location = g("search", a)
                }
            }
            var p = document.getElementById("tutor-admin-bulk-action-btn");
            var y = document.querySelector(".tutor-bulk-modal-disabled");
            if (p) {
                p.onclick = function() {
                    var e = [];
                    var a = document.querySelectorAll(".tutor-bulk-checkbox");
                    var n = o(a),
                        i;
                    try {
                        for (n.s(); !(i = n.n()).done;) {
                    ...
                    if (e.length) {
                        y.setAttribute("id", "tutor-bulk-confirm-popup")
                    } else {
                        tutor_toast(u("Warning", "tutor"), u("Nothing was selected for bulk action.", "tutor"), "error");
                        if (y.hasAttribute("id")) {
                            y.removeAttribute("id")
                        }
                    }
                }
            }
            var f = document.getElementById("tutor-admin-bulk-action-form");
            if (f) {
                f.onsubmit = function() {
                    var e = r(i().mark((function e(a) {
                        var n, t, r, d, m, c, s, l, h, p, y, v;
                        return i().wrap((function e(i) {
                            while (1) switch (i.prev = i.next) {
                                case 0:
                                    ...
                                    n = new FormData(f);
                                    t = [];
                                    r = document.querySelectorAll(".tutor-bulk-checkbox");
                                    d = o(r);
                                    try {
                                        for (d.s(); !(m = d.n()).done;) {
                                            c = m.value;
                                    ...
                                    alert(u("Select checkbox for action", "tutor"));
                                ...
                                case 22:
                                    h = i.sent;
                                    if (h.success || 200 === (h === null || h === void 0 ? void 0 : h.status_code)) {
                                        location.reload()
                                    } else {
                                        p = h.data || {}, y = p.message, v = y === void 0 ? u("Something went wrong, please try again ", "tutor") : y;
                                        tutor_toast(u("Failed", "tutor"), v, "error")
                                    }
                                case 24:
                                    i.next = 29;
                                    break;
            ...
            var v = document.getElementById("tutor-confirm-bulk-action");
            if (v) {
                v.onclick = function() {
            ...
            var _ = document.querySelector("#tutor-bulk-checkbox-all");
            if (_) {
            ...
            var b = document.querySelectorAll(".tutor-admin-course-delete");
            var S = o(b),
                M;
            try {
                for (S.s(); !(M = S.n()).done;) {
                    ...
                    D.onclick = function(e) {
                        ...
                        if (n) {
                            n.elements.action.value = "tutor_course_delete";
                            n.elements.id.value = a
                        }
                    }
                }
            } catch (e) {
            ...
            var k = document.querySelectorAll(".tutor-delete-permanently");
            var P = o(k),
                w;
            try {
                for (P.s(); !(w = P.n()).done;) {
                    ...
                    C.onclick = function(e) {
                        var a = e.currentTarget.dataset.id;
                        var i = e.currentTarget.dataset.action;
                        if (n) {
                            n.elements.action.value = i;
                            n.elements.id.value = a
                        }
                    }
                }
            ...
            if (n) {
                n.onsubmit = function() {
                    var t = r(i().mark((function t(r) {
                        var o, d, m, c;
                        return i().wrap((function i(t) {
                            while (1) switch (t.prev = t.next) {
                                case 0:
                                    r.preventDefault();
                                    o = new FormData(n);
                                    d = n.querySelector("[data-tutor-modal-submit]");
                                    d.classList.add("is-loading");
                                    t.next = 6;
                                    return j(o);
                                case 6:
                                    m = t.sent;
                                    if (e.classList.contains("tutor-is-active")) {
                                ...
                                case 11:
                                    ...
                                    if (c) {
                                        if (a(c) === "object" && c.success) {
                                            tutor_toast(u("Delete", "tutor"), c.data, "success");
                                            location.reload(true)
                                        } else if (a(c) === "object" && c.success === false) {
                                            tutor_toast(u("Failed", "tutor"), c.data, "error")
                                        } else {
                                            tutor_toast(u("Delete", "tutor"), u("Successfully deleted ", "tutor"), "success");
                                            location.reload()
                                        }
                                    } else {
                                        tutor_toast(u("Failed", "tutor"), u("Delete failed ", "tutor"), "error")
                                    }
                                case 14:
                                case "end":
                                    return t.stop()
                    ...
                    return i().wrap((function e(i) {
                        while (1) switch (i.prev = i.next) {
                            ...
                            case 7:
                                i.prev = 7;
                                i.t0 = i["catch"](0);
                                tutor_toast(u("Operation failed", "tutor"), i.t0, "error");
                            case 10:
                            case "end":
                                return i.stop()
                        }
        ...
        function v() {
            ...
            var e = {},
                a = Object.prototype,
                n = a.hasOwnProperty,
                i = Object.defineProperty || function(e, a, n) {
                    e[a] = n.value
                },
                t = "function" == typeof Symbol ? Symbol : {},
                r = t.iterator || "@@iterator",
                o = t.asyncIterator || "@@asyncIterator",
                d = t.toStringTag || "@@toStringTag";
            ...
            function c(e, a, n, t) {
                var r = a && a.prototype instanceof l ? a : l,
            ...
            var g = Object.getPrototypeOf,
                _ = g && g(g(j([])));
            _ && _ !== a && n.call(_, r) && (y = _);
            var b = p.prototype = l.prototype = Object.create(y);
            ...
            function M(e, a) {
                function t(i, r, o, d) {
                    ...
                    if ("throw" !== m.type) {
                        var c = m.arg,
                            s = c.value;
                        return s && "object" == f(s) && n.call(s, "__await") ? a.resolve(s.__await).then((function(e) {
                            t("next", e, o, d)
                        }), (function(e) {
                            t("throw", e, o, d)
                        })) : a.resolve(s).then((function(e) {
                            c.value = e, o(c)
                        }), (function(e) {
                            return t("throw", e, o, d)
                        }))
                    }
                    d(m.arg)
                }
            ...
            function D(e, a, n) {
                ...
                return function(t, r) {
                    ...
                    for (n.method = t, n.arg = r;;) {
                        ...
                        var m = u(e, a, n);
                        if ("normal" === m.type) {
                            if (i = n.done ? "completed" : "suspendedYield", m.arg === s) continue;
                            return {
                                value: m.arg,
                                done: n.done
                            }
            ...
            function k(e, a) {
                var n = a.method,
                    i = e.iterator[n];
                if (undefined === i) return a.delegate = null, "throw" === n && e.iterator["return"] && (a.method = "return", a.arg = undefined, k(e, a), "throw" === a.method) || "return" !== n && (a.method = "throw", a.arg = new TypeError("The iterator does not provide a '" + n + "' method")), s;
                var t = u(i, e.iterator, a.arg);
                if ("throw" === t.type) return a.method = "throw", a.arg = t.arg, a.delegate = null, s;
                var r = t.arg;
                return r ? r.done ? (a[e.resultName] = r.value, a.next = e.nextLoc, "return" !== a.method && (a.method = "next", a.arg = undefined), a.delegate = null, s) : r : (a.method = "throw", a.arg = new TypeError("iterator result is not an object"), a.delegate = null, s)
            }
                ...
                if (e) {
                    ...
                    if (!isNaN(e.length)) {
                        var i = -1,
                            t = function a() {
                                for (; ++i < e.length;)
                                    if (n.call(e, i)) return a.value = e[i], a.done = !1, a;
                                return a.value = undefined, a.done = !0, a
                            };
                        return t.next = t
                    }
            ...
            return h.prototype = p, i(b, "constructor", {
                value: p,
                configurable: !0
            }), i(p, "constructor", {
                value: h,
                configurable: !0
            }), h.displayName = m(p, d, "GeneratorFunction"), e.isGeneratorFunction = function(e) {
                var a = "function" == typeof e && e.constructor;
                return !!a && (a === h || "GeneratorFunction" === (a.displayName || a.name))
            }, e.mark = function(e) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, m(e, d, "GeneratorFunction")), e.prototype = Object.create(b), e
            }, e.awrap = function(e) {
                return {
                    __await: e
                }
            }, S(M.prototype), m(M.prototype, o, (function() {
                return this
            })), e.AsyncIterator = M, e.async = function(a, n, i, t, r) {
                void 0 === r && (r = Promise);
                var o = new M(c(a, n, i, t), r);
                return e.isGeneratorFunction(n) ? o : o.next().then((function(e) {
                    return e.done ? e.value : o.next()
                }))
            }, S(b), m(b, d, "Generator"), m(b, r, (function() {
                return this
                ...
                reset: function e(a) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(w), !a)
                        for (var i in this) "t" === i.charAt(0) && n.call(this, i) && !isNaN(+i.slice(1)) && (this[i] = undefined)
                },
                stop: function e() {
                    this.done = !0;
                    var a = this.tryEntries[0].completion;
                ...
                dispatchException: function e(a) {
                    ...
                    function t(e, n) {
                        return d.type = "throw", d.arg = a, i.next = e, n && (i.method = "next", i.arg = undefined), !!n
                    }
                    for (var r = this.tryEntries.length - 1; r >= 0; --r) {
                        var o = this.tryEntries[r],
                            d = o.completion;
                ...
                abrupt: function e(a, i) {
                    ...
                    o && ("break" === a || "continue" === a) && o.tryLoc <= i && i <= o.finallyLoc && (o = null);
                    var d = o ? o.completion : {};
                    return d.type = a, d.arg = i, o ? (this.method = "next", this.next = o.finallyLoc, s) : this.complete(d)
                },
                complete: function e(a, n) {
                    if ("throw" === a.type) throw a.arg;
                    return "break" === a.type || "continue" === a.type ? this.next = a.arg : "return" === a.type ? (this.rval = this.arg = a.arg, this.method = "return", this.next = "end") : "normal" === a.type && n && (this.next = n), s
                },
                finish: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                        var i = this.tryEntries[n];
                        if (i.finallyLoc === a) return this.complete(i.completion, i.afterLoc), w(i), s
                    }
                },
                catch: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
        ...
        function M(e, a) {
            if (!e) return;
            if (typeof e === "string") return P(e, a);
            var n = Object.prototype.toString.call(e).slice(8, -1);
            if (n === "Object" && e.constructor) n = e.constructor.name;
            if (n === "Map" || n === "Set") return Array.from(e);
            if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return P(e, a)
        }
        ...
        jQuery(document).ready((function(e) {
            e(".tutor-sortable-list").sortable()
        }));
        document.addEventListener("DOMContentLoaded", (function(e) {
            var a = wp.i18n,
                ...
                t = a._n,
                r = a._nx;
            var o = document.querySelector(".tutor-lesson-sidebar.tutor-desktop-sidebar");
            var d = document.querySelector(".tutor-sidebar-toggle-anchor");
            if (o && d) {
                d.addEventListener("click", (function() {
                    if (getComputedStyle(o).flex === "0 0 400px") {
                        o.style.flex = "0 0 0px";
                        o.style.display = "none"
                    } else {
                        o.style.display = "block";
                        o.style.flex = "0 0 400px"
                    }
                }))
            }
            var m = document.querySelector(".tutor-sidebar-tabs-content");
            if (m) {
                var c = m.getBoundingClientRect().top;
                m.style.height = "calc(100vh - ".concat(c, "px)")
            }
            var u = function e(a) {
                var n = document.querySelector(".tutor-desktop-sidebar-area");
                if (null !== n && n.children.length < 2) {
                    return
                }
                a.forEach((function(e) {
                    e.addEventListener("click", (function(e) {
                        var a = e.currentTarget.parentNode.nextElementSibling;
                        i(a);
                        e.currentTarget.classList.add("active");
                        var n = e.currentTarget.getAttribute("data-sidebar-tab");
                        var t = a.querySelector("#" + n);
                        t.classList.add("active");
                        var r = document.querySelector(".tutor-lessons-tab-area");
                        var o = r.offsetHeight;
                        if (n == "sidebar-qna-tab-content") {
                            t.style.height = "calc(100% - ".concat(o, "px)")
                        }
                    }))
                }));
                var i = function e(n) {
                    ...
                    var t = n.querySelectorAll(".tutor-lesson-sidebar-tab-item");
                    for (var r = 0; r < t.length; r++) {
                        t[r].classList.remove("active")
                    }
                }
            };
            var s = document.querySelectorAll(".tutor-desktop-sidebar-area .tutor-sidebar-tab-item");
            var l = document.querySelectorAll(".tutor-mobile-sidebar-area .tutor-sidebar-tab-item");
            if (s) {
                u(s)
            }
            if (l) {
            ...
            var h = document.querySelectorAll(".tutor-comment-textarea textarea");
            if (h) {
            ...
            function y() {
                var e = document.querySelectorAll(".tutor-comments-list.tutor-parent-comment");
                var a = document.querySelector(".tutor-comment-box.tutor-reply-box");
                if (e) {
                    b(e).forEach((function(e) {
                        var n = e.querySelectorAll(".tutor-comments-list.tutor-child-comment");
                        var i = e.querySelector(".tutor-comment-line");
                        var t = n.length;
                        if (n[t - 1]) {
                            var r = n[t - 1].clientHeight;
                            var o = r + a.clientHeight + 20 - 25 + 50;
                            i.style.setProperty("height", "calc(100% - ".concat(o, "px)"))
                        }
                    }))
                }
            }
            y();
            window.addEventListener(_tutorobject.content_change_event, y);
            var f = document.querySelectorAll(".tutor-draggable > div");
            var g = document.querySelectorAll(".tutor-dropzone");
            ...
            function D(e) {
                ...
                if (a === "touchstart") {
                    ...
                    var n = e.target.closest(".tutor-dragging");
                    var i = document.querySelector(".tutor-drag-copy");
                    if (n) {
                        ...
                        if (!i) {
                            i = n.cloneNode(true);
                            i.classList.add("tutor-drag-copy");
                            n.parentNode.appendChild(i)
                        }
                        i.style.position = "fixed";
                        i.style.left = o - i.clientWidth / 2 + "px";
                        i.style.top = r - i.clientHeight / 2 + "px";
                        i.style.zIndex = "9999";
                        i.style.opacity = "0.5";
                    ...
                    var l = document.querySelector(".tutor-drag-copy");
                    if (l) {
                        l.remove();
                        var h = typeof e.originalEvent === "undefined" ? e : e.originalEvent;
                        var p = h.touches[0] || h.changedTouches[0];
                        var y = [p.clientX, p.clientY],
                            f = y[0],
                            v = y[1];
                        var g = document.elementFromPoint(f, v);
                        if (g.classList.contains("tutor-dropzone") || g.closest(".tutor-dropzone")) {
                            if (!g.classList.contains("tutor-dropzone")) {
                                g = g.closest(".tutor-dropzone")
                            }
                            var _ = l.querySelector("input");
                            var b = _.dataset.name;
                            var S = document.createElement("input");
                            S.type = "text";
                            S.setAttribute("value", _.value);
                            S.setAttribute("name", b);
                            g.appendChild(S);
                            var D = l.querySelector(".tutor-dragging-text-conent").textContent;
                            g.querySelector(".tutor-dragging-text-conent").textContent = D;
                            g.querySelector(".tutor-dragging-text-conent").classList.add("tutor-color-black");
            ...
            function R() {
                var e = document.querySelector(".tutor-quiz-border-box.tutor-dragging");
                if (this.querySelector("input")) {
                    this.querySelector("input").remove()
                }
                var a = e.querySelector("input");
                var n = a.dataset.name;
                var i = document.createElement("input");
                i.type = "text";
                i.setAttribute("value", a.value);
                i.setAttribute("name", n);
                this.appendChild(i);
                var t = e.querySelector(".tutor-dragging-text-conent").textContent;
                this.querySelector(".tutor-dragging-text-conent").textContent = t;
                this.querySelector(".tutor-dragging-text-conent").classList.add("tutor-color-black");
                this.classList.remove("tutor-drop-over")
            }
            var E = document.getElementById("tutor-assignment-file-upload");
            if (E) {
            ...
            function T() {
                var e;
                var a = b(E.files).reduce((function(e, a) {
                    return e + a.size
                }), 0);
                var i = parseInt((e = document.querySelector('input[name="tutor_assignment_upload_limit"]')) === null || e === void 0 ? void 0 : e.value) || 0;
                var t = "";
                var r = window._tutorobject.assignment_max_file_allowed;
                var o = document.querySelectorAll("#tutor-student-assignment-edit-file-preview .tutor-instructor-card").length;
                var d = r - o;
                if (E.files.length > d) {
                    E.value = null;
                    tutor_toast(n("Warning", "tutor"), n("Max ".concat(r, " file allowed to upload"), "tutor"), "error");
                    return
                }
                if (a > i) {
                    E.value = null;
                    tutor_toast(n("Warning", "tutor"), n("File size exceeds maximum limit ".concat(Math.floor(i / 1e6), " MB."), "tutor"), "error");
                    return
                }
                if ("files" in E) {
                    if (E && E.files.length == 0) {
                        t = "Select one or more files."
                    } else {
                        if (E.files.length > d) {
                            tutor_toast(n("Warning", "tutor"), n("Max ".concat(r, " file allowed to upload"), "tutor"), "error")
                        }
                        ...
                        var u = document.getElementById("tutor-student-assignment-edit-file-preview");
                        for (var s = 0; s < d; s++) {
                            var l = E.files[s];
                            if (!l) {
                                continue
                            }
                            var h = u ? "tutor-col-sm-5 tutor-py-16 tutor-mr-16" : "";
                            m += '<div class="tutor-instructor-card '.concat(h, '">\n                                    <div class="tutor-icard-content">\n                                        <div class="tutor-fs-6 tutor-color-secondary">\n                                            ').concat(l.name, '\n                                        </div>\n                                        <div class="tutor-fs-7">Size: ').concat(l.size, '</div>\n                                    </div>\n                                    <div onclick="(() => {\n\t\t\t\t\t\t\t\t\t\tthis.closest(\'.tutor-instructor-card\').remove();\n\t\t\t\t\t\t\t\t\t})()" class="tutor-attachment-file-close tutor-iconic-btn tutor-iconic-btn-outline flex-center">\n                                        <span class="tutor-icon-times"></span>\n                                    </div>\n                                </div>')
                        }
                        if (c) {
                            c.innerHTML = m
                        }
                        if (u) {
                            u.insertAdjacentHTML("beforeend", m)
                        }
                    }
                }
            }
            var N = document.querySelectorAll(".tutor-attachment-file-close a");
            N.forEach((function(e) {
                e.onclick = function() {
                    var e = _(v().mark((function e(a) {
                        var i, t, r, o, d, m, c;
                        return v().wrap((function e(u) {
                            while (1) switch (u.prev = u.next) {
                                case 0:
                                    ...
                                    r = i.dataset.id;
                                    o = new FormData;
                                    o.set("action", "tutor_remove_assignment_attachment");
                                    o.set("assignment_comment_id", r);
                                    o.set("file_name", t);
                                    o.set(window.tutor_get_nonce_data(true).key, window.tutor_get_nonce_data(true).value);
                                    d = i.querySelector("span");
                                ...
                                case 17:
                                    c = u.sent;
                                    if (!c) {
                                        tutor_toast(n("Warning", "tutor"), n("Attachment remove failed", "tutor"), "error")
                                    } else {
                                        i.closest(".tutor-instructor-card").remove()
                                    }
                                    u.next = 23;
                                    break;
                                case 21:
        ...
        function N(e, a) {
            ...
            if (n === "Object" && e.constructor) n = e.constructor.name;
            if (n === "Map" || n === "Set") return Array.from(e);
            if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return K(e, a)
        }
        ...
        function x(e, a) {
            ...
            if (null != n) {
                var i, t, r, o, d = [],
                    ...
                    c = !1;
                try {
                    if (r = (n = n.call(e)).next, 0 === a) {
                        if (Object(n) !== n) return;
                        m = !1
                    } else
                        for (; !(m = (i = r.call(n)).done) && (d.push(i.value), d.length !== a); m = !0);
                } catch (e) {
                    c = !0, t = e
                } finally {
                    try {
                        if (!m && null != n["return"] && (o = n["return"](), Object(o) !== o)) return
                    } finally {
                        if (c) throw t
                    }
                }
        ...
        function H() {
            ...
            function b(e, a) {
                function t(i, r, o, d) {
                    ...
                    if ("throw" !== m.type) {
                        var c = m.arg,
                            s = c.value;
                        return s && "object" == X(s) && n.call(s, "__await") ? a.resolve(s.__await).then((function(e) {
                            t("next", e, o, d)
                        }), (function(e) {
                            t("throw", e, o, d)
                        })) : a.resolve(s).then((function(e) {
            ...
            function M(e, a) {
                var n = a.method,
                    i = e.iterator[n];
                if (undefined === i) return a.delegate = null, "throw" === n && e.iterator["return"] && (a.method = "return", a.arg = undefined, M(e, a), "throw" === a.method) || "return" !== n && (a.method = "throw", a.arg = new TypeError("The iterator does not provide a '" + n + "' method")), s;
                var t = u(i, e.iterator, a.arg);
                if ("throw" === t.type) return a.method = "throw", a.arg = t.arg, a.delegate = null, s;
                var r = t.arg;
                return r ? r.done ? (a[e.resultName] = r.value, a.next = e.nextLoc, "return" !== a.method && (a.method = "next", a.arg = undefined), a.delegate = null, s) : r : (a.method = "throw", a.arg = new TypeError("iterator result is not an object"), a.delegate = null, s)
            ...
            return h.prototype = p, i(g, "constructor", {
                value: p,
                configurable: !0
            }), i(p, "constructor", {
                value: h,
                ...
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, p) : (e.__proto__ = p, m(e, d, "GeneratorFunction")), e.prototype = Object.create(g), e
            }, e.awrap = function(e) {
                return {
                    __await: e
                }
            }, _(b.prototype), m(b.prototype, o, (function() {
                return this
            })), e.AsyncIterator = b, e.async = function(a, n, i, t, r) {
                void 0 === r && (r = Promise);
                var o = new b(c(a, n, i, t), r);
                return e.isGeneratorFunction(n) ? o : o.next().then((function(e) {
                    return e.done ? e.value : o.next()
                }))
            }, _(g), m(g, d, "Generator"), m(g, r, (function() {
                return this
                ...
                constructor: P,
                reset: function e(a) {
                    if (this.prev = 0, this.next = 0, this.sent = this._sent = undefined, this.done = !1, this.delegate = null, this.method = "next", this.arg = undefined, this.tryEntries.forEach(k), !a)
                        for (var i in this) "t" === i.charAt(0) && n.call(this, i) && !isNaN(+i.slice(1)) && (this[i] = undefined)
                },
                stop: function e() {
                    this.done = !0;
                ...
                finish: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
                        var i = this.tryEntries[n];
                        if (i.finallyLoc === a) return this.complete(i.completion, i.afterLoc), k(i), s
                    }
                },
                catch: function e(a) {
                    for (var n = this.tryEntries.length - 1; n >= 0; --n) {
        ...
        function Z(e, a) {
            ...
            if (n === "Object" && e.constructor) n = e.constructor.name;
            if (n === "Map" || n === "Set") return Array.from(e);
            if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return $(e, a)
        }
        ...
        var ee = wp.i18n.__;
        var ae = ["keyword", "course_order", "tutor-course-filter-level", "tutor-course-filter-tag", "tutor-course-filter-category", "tutor-course-filter-price", "course_filter", "supported_filters", "current_page", "action"];
        var ne = function e(a) {
            var n = new URL(window.location.origin + window.location.pathname);
            var i = ie();
            for (var t in i) {
                if (ae.indexOf(t) == -1) {
                    n.searchParams.append(t, i[t])
                }
            }
            var r = function e() {
                var i = Array.isArray(a[o]);
                var t = i ? o + "[]" : o;
                var r = i ? a[o] : [a[o]];
        ...
        var ie = function e() {
            var a = {};
            new URL(window.location).searchParams.forEach((function(e, n) {
                if (n.slice(-2) == "[]") {
                    var i = n.slice(0, -2);
                    !a[i] ? a[i] = [] : 0;
                    !Array.isArray(a[i]) ? a[i] = [a[i]] : 0;
                    a[i].push(e)
                } else {
                    a[n] = e
                }
        ...
        var te = function e(a) {
            var n = ie();
            a.find('[type="checkbox"]').prop("checked", false);
            a.find('[type="text"], select').val("");
            var i = function e() {
                var i = n[t];
                var r = a.find('[name="' + t + '"]');
                if (r.eq(0).attr("type") == "checkbox") {
                    ...
                    r.each((function() {
                        var e = o.indexOf(window.jQuery(this).attr("value")) > -1;
                        window.jQuery(this).prop("checked", e)
                    }))
                } else {
                    r.val(i)
                }
        ...
        window.jQuery(document).ready((function(e) {
            var a = window.wp.i18n.__;
            var n = e("[tutor-course-filter] form");
            if (!n.length) {
                return
            }
            var i = e("[tutor-course-list-container]");
            var t = e(".tutor-courses-wrap").data("tutor_courses_meta") || {};
            var r = {};
            ...
            var o = function o() {
                var d = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
                var m = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
                var c = ie();
                var u = Object.assign(n.serializeObject(), r, t);
                u.current_page = m && c.current_page ? c.current_page : 1;
                u.action = "tutor_course_filter_ajax";
                if (d) {
                    ne(u)
                }
                i.html('<div class="tutor-spinner-wrap"><span class="tutor-spinner" area-hidden="true"></span></div>');
                n.find("[action-tutor-clear-filter]").closest(".tutor-widget-course-filter").removeClass("tutor-d-none");
                if (!("category" in u.supported_filters)) {
                    var s = "tutor-course-filter-category";
                    ...
                    if (l.length > 0) {
                        ...
                        u["tutor-course-filter-category"] = W(new Set(h))
                    } else {
                        u["tutor-course-filter-category"] = JSON.parse(e("#course_filter_categories").val())
                    }
                }
                var p = "tutor-course-filter-exclude-ids";
                var y = Object.keys(c).filter((function(e) {
                    return e.includes(p)
                }));
                var f = [];
                if (y.length > 0) {
                    ...
                    u["tutor-course-filter-exclude-ids"] = W(new Set(f))
                } else {
                    if (e("#course_filter_exclude_ids").length) {
                        u["tutor-course-filter-exclude-ids"] = JSON.parse(e("#course_filter_exclude_ids").val())
                    }
                }
                var v = "tutor-course-filter-post-ids";
                var g = Object.keys(c).filter((function(e) {
                    return e.includes(v)
                }));
                var _ = [];
                if (g.length > 0) {
                    ...
                    u["tutor-course-filter-post-ids"] = W(new Set(_))
                } else {
                    if (e("#course_filter_post_ids").length) {
                        u["tutor-course-filter-post-ids"] = JSON.parse(e("#course_filter_post_ids").val())
                    }
                }
                e.ajax({
                    url: window._tutorobject.ajaxurl,
                    ...
                    success: function e(n) {
                        if (!n.success) {
                            i.html(a("Could not load courses", "tutor"));
                            return
                        }
                        i.html(n.data.html).find("nav").css("display", "flex")
                    }
                })
            };
            e("[tutor-toggle-course-filter]").on("click", (function(a) {
                a.preventDefault();
                e("body").toggleClass("tutor-course-filter-open");
                if (e(".tutor-course-filter-backdrop").length == 0) {
                    e("body").append(e('<div class="tutor-course-filter-backdrop" area-hidden="true"></div>').hide().fadeIn(150))
                }
            }));
            e("[tutor-hide-course-filter]").on("click", (function(a) {
                a.preventDefault();
                e("body").removeClass("tutor-course-filter-open")
            }));
            var d = document.querySelectorAll(".tutor-course-list-enroll");
            d.forEach((function(e) {
                e.onclick = function() {
                    var e = V(H().mark((function e(n) {
                        var i, t, r, o, d, m, c, u;
                        return H().wrap((function e(s) {
                            while (1) switch (s.prev = s.next) {
                                case 0:
                                    n.preventDefault();
                                    i = a("Something went wrong, please try again!", "tutor");
                                    t = n.target;
                                    r = [{
                                ...
                                case 13:
                                    m = s.sent;
                                    console.log(m);
                                    c = m.success, u = m.data;
                                    if (c) {
                                        tutor_toast(a("Success", "tutor-pro"), u, "success");
                                        window.location.href = t.href
                                    } else {
                                        tutor_toast(a("Failed", "tutor-pro"), u ? u : i, "error")
                                    }
                                    s.next = 20;
                                    break;
                                case 19:
                                    tutor_toast(a("Error", "tutor-pro"), a(i), "error");
                                case 20:
        ...
        window.jQuery(document).ready((function(e) {
            e(document).on("click", ".tutor-course-entry-box-login button, .tutor-course-entry-box-login a, .tutor-open-login-modal", (function(a) {
                a.preventDefault();
                var n = e(this).data("login_url") || e(this).closest(".tutor-course-entry-box-login").data("login_url");
                if (n) {
        ...
        var re = document.querySelector(".tutor-password-protected-course");
        if (re) {
            var oe = document.querySelector("body");
            oe.style.overflow = "hidden";
            var de = re.querySelector('input[type="password"]');
            var me = re.querySelector('input[type="checkbox"]');
            ...
            function b(e, a) {
                function t(i, r, o, d) {
                    ...
                    if ("throw" !== m.type) {
                        var c = m.arg,
                            s = c.value;
                        return s && "object" == he(s) && n.call(s, "__await") ? a.resolve(s.__await).then((function(e) {
                            t("next", e, o, d)
                        }), (function(e) {
                            t("throw", e, o, d)
                        })) : a.resolve(s).then((function(e) {
        ...
        var ve = wp.i18n.__;
        document.addEventListener("DOMContentLoaded", (function() {
            var e = ve("Something went wrong, please try again", "tutor");
            var a = document.querySelector("#user_billing_form");
            if (a) {
                var n = a.querySelector('button[type="submit"]');
                a.addEventListener("submit", function() {
                    var a = fe(pe().mark((function a(i) {
                        var t, r, o, d, m, c;
                        return pe().wrap((function a(u) {
                            while (1) switch (u.prev = u.next) {
                                case 0:
                                    i.preventDefault();
                                    t = new FormData(i.target);
                                    u.prev = 2;
                                ...
                                case 10:
                                    ...
                                    c = m === void 0 ? e : m;
                                    if (d === 200) {
                                        tutor_toast(ve("Success", "tutor"), c, "success")
                                    } else {
                                        tutor_toast(ve("Failed", "tutor"), c, "error")
                                    }
                                    u.next = 20;
                                    break;
                                case 17:
                                    u.prev = 17;
                                    u.t0 = u["catch"](2);
                                    tutor_toast(ve("Failed", "tutor"), e, "error");
                                case 20:
                                    u.prev = 20;
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            var a = jQuery(".tutor-table-responsive .tutor-table .tutor-dropdown");
            if (a.length) {
                var n = jQuery(".tutor-table-responsive .tutor-table").height();
                jQuery(".tutor-table-responsive").css("min-height", n + 110)
            }
        }));
        var De = n(1626);
        var ke = n(9834);
            ...
            function b(e, a) {
                function t(i, r, o, d) {
                    ...
                    if ("throw" !== m.type) {
                        var c = m.arg,
                            s = c.value;
                        return s && "object" == we(s) && n.call(s, "__await") ? a.resolve(s.__await).then((function(e) {
                            t("next", e, o, d)
                        }), (function(e) {
                            t("throw", e, o, d)
                        })) : a.resolve(s).then((function(e) {
        ...
        var Le = wp.i18n.__;
        document.addEventListener("DOMContentLoaded", (function() {
            var e = Le("Something went wrong, please try again", "tutor");
            document.addEventListener("click", function() {
                var a = Ae(Ce().mark((function a(n) {
                    var i, t, r, o, d, m, c, u, s, l, h, y;
                    return Ce().wrap((function a(f) {
                        while (1) switch (f.prev = f.next) {
                            case 0:
                                i = n.target.closest(".tutor-native-add-to-cart");
                                if (!i) {
                                    f.next = 27;
                                    break
                                }
                                t = F([{
                                    ...
                                    course_id: i.dataset.courseId
                                }]);
                                r = document.body.classList.contains("single-courses") || document.body.classList.contains("single-course-bundle");
                                f.prev = 4;
                            ...
                            case 12:
                                ...
                                s = u === void 0 ? e : u;
                                if (m === 201) {
                                    tutor_toast(Le("Success", "tutor"), s, "success");
                                    h = '<a href="'.concat((l = c === null || c === void 0 ? void 0 : c.cart_page_url) !== null && l !== void 0 ? l : "#", '" class="tutor-btn tutor-btn-outline-primary ').concat(r ? "tutor-btn-lg tutor-btn-block" : "tutor-btn-md", " ").concat(!(c !== null && c !== void 0 && c.cart_page_url) ? "tutor-cart-page-not-configured" : "", '">').concat(Le("View Cart", "tutor"), "</a>");
                                    i.parentElement.innerHTML = h;
                                    y = new CustomEvent("tutorAddToCartEvent", {
                                        detail: {
                                            cart_count: c === null || c === void 0 ? void 0 : c.cart_count
                                        }
                                    });
                                    document.dispatchEvent(y)
                                } else {
                                    tutor_toast(Le("Failed", "tutor"), s, "error")
                                }
                                f.next = 23;
                                break;
                            case 20:
                                f.prev = 20;
                                f.t0 = f["catch"](4);
                                tutor_toast(Le("Failed", "tutor"), e, "error");
                            case 23:
                                f.prev = 23;
            ...
            var a = document.querySelector(".tutor-cart-page");
            if (a) {
                document.addEventListener("click", function() {
                    var a = Ae(Ce().mark((function a(n) {
                        var i, t, r, o, d, m, c, u, s;
                        return Ce().wrap((function a(l) {
                            while (1) switch (l.prev = l.next) {
                                case 0:
                                    i = n.target.closest(".tutor-cart-remove-button");
                                    if (!i) {
                                        l.next = 26;
                                        break
                                    }
                                ...
                                case 11:
                                    ...
                                    u = c === void 0 ? e : c;
                                    if (d === 200) {
                                        document.querySelector(".tutor-cart-page-wrapper").parentElement.innerHTML = m === null || m === void 0 ? void 0 : m.cart_template;
                                        tutor_toast(Le("Success", "tutor"), u, "success");
                                        s = new CustomEvent("tutorRemoveCartEvent", {
                                            detail: {
                                                cart_count: m === null || m === void 0 ? void 0 : m.cart_count
                                            }
                                        });
                                        document.dispatchEvent(s)
                                    } else {
                                        tutor_toast(Le("Failed", "tutor"), u, "error")
                                    }
                                    l.next = 22;
                                    break;
                                case 19:
            ...
            function b(e, a) {
                function t(i, r, o, d) {
                    ...
                    if ("throw" !== m.type) {
                        var c = m.arg,
                            s = c.value;
                        return s && "object" == Be(s) && n.call(s, "__await") ? a.resolve(s.__await).then((function(e) {
                            t("next", e, o, d)
                        }), (function(e) {
                            t("throw", e, o, d)
                        })) : a.resolve(s).then((function(e) {
        ...
        var Ne = wp.i18n.__;
        document.addEventListener("DOMContentLoaded", (function() {
            var e = Ne("Something went wrong, please try again", "tutor");
            var a = document.querySelector(".tutor-checkout-page");
            if (a) {
                var n = function() {
                    var e = Te(Re().mark((function e(a) {
                        var n, i, t, r, o, d;
                        return Re().wrap((function e(m) {
                            while (1) switch (m.prev = m.next) {
                                case 0:
                                    n = new URL(window.location.href);
                                    i = n.searchParams.get("plan");
                                    t = new FormData;
                                    t.set(window.tutor_get_nonce_data(true).key, window.tutor_get_nonce_data(true).value);
                                    t.set("action", "tutor_get_checkout_html");
                                    t.set("coupon_code", a);
                                    if (i) {
                                        t.set("plan", i)
                                    }
                                ...
                                case 12:
                                    o = m.sent;
                                    d = document.querySelector("[tutor-checkout-details]");
                                    if (d) {
                                        d.innerHTML = o.data
                                    }
                                case 15:
                ...
                var i = function() {
                    var e = Te(Re().mark((function e(a) {
                        var n, i;
                        return Re().wrap((function e(t) {
                            while (1) switch (t.prev = t.next) {
                                case 0:
                                    a.set(window.tutor_get_nonce_data(true).key, window.tutor_get_nonce_data(true).value);
                                    a.set("action", "tutor_save_billing_info");
                                    t.next = 4;
                                    return p(a);
                                case 4:
                                    n = t.sent;
                ...
                var t = document.querySelector(".tutor-apply-coupon-form");
                var r = t === null || t === void 0 ? void 0 : t.querySelector("input");
                var o = t === null || t === void 0 ? void 0 : t.querySelector("button");
                var d = document.querySelector(".tutor-checkout-payment-options");
                if (d) {
                    var m = document.querySelector("input[name=payment_type]");
                    var c = d.querySelectorAll("label");
                    c.forEach((function(e) {
                        e.addEventListener("click", (function(a) {
                            ...
                            m.value = e.dataset.paymentType;
                            var n = e.dataset.paymentInstruction;
                            if (n) {
                                document.querySelector(".tutor-payment-instructions").classList.remove("tutor-d-none");
                                document.querySelector(".tutor-payment-instructions").textContent = n
                            } else {
                ...
                document.addEventListener("click", (function(e) {
                    if (e.target.closest("#tutor-toggle-coupon-button")) {
                        var a = document.querySelector(".tutor-apply-coupon-form");
                        var n = a === null || a === void 0 ? void 0 : a.querySelector("input");
                        if (a.classList.contains("tutor-d-none")) {
                            a.classList.remove("tutor-d-none");
                            n.focus()
                        } else {
                            a.classList.add("tutor-d-none")
                        }
                    }
                }));
                document.addEventListener("keydown", (function(e) {
                    if (e.key === "Enter" && e.target.closest("input[name=coupon_code]")) {
                        e.preventDefault();
                        var a = e.target.parentNode.querySelector("#tutor-apply-coupon-button");
                        a === null || a === void 0 ? void 0 : a.click()
                    }
                }));
                document.addEventListener("click", function() {
                    var a = Te(Re().mark((function a(i) {
                        var t, r, o, d, m, c, u, s, l, h, y, f;
                        return Re().wrap((function a(v) {
                            while (1) switch (v.prev = v.next) {
                                case 0:
                                    if (!i.target.closest("#tutor-apply-coupon-button")) {
                                        v.next = 37;
                                        break
                                    }
                                    r = new URL(window.location.href);
                                    o = r.searchParams.get("plan");
                                    d = (t = document.querySelector(".tutor-apply-coupon-form input")) === null || t === void 0 ? void 0 : t.value;
                                    m = document.querySelector(".tutor-apply-coupon-form button");
                                    if (!(d.length === 0)) {
                                        v.next = 8;
                                        break
                                    }
                                    tutor_toast(Ne("Failed", "tutor"), Ne("Please add a coupon code.", "tutor"), "error");
                                    return v.abrupt("return");
                                case 8:
                                    c = new FormData;
                                    c.set(window.tutor_get_nonce_data(true).key, window.tutor_get_nonce_data(true).value);
                                    c.set("action", "tutor_apply_coupon");
                                    c.set("coupon_code", d);
                                    c.set("object_ids", m.dataset.objectIds);
                                    if (o) {
                                        c.set("plan", o)
                                    }
                                    v.prev = 14;
                                ...
                                case 22:
                                    ...
                                    f = y === void 0 ? e : y;
                                    if (l === 200) {
                                        tutor_toast(Ne("Success", "tutor"), f, "success");
                                        n(d)
                                    } else {
                                        tutor_toast(Ne("Failed", "tutor"), f, "error")
                                    }
                                    v.next = 33;
                                    break;
                                case 30:
                                    v.prev = 30;
                                    v.t0 = v["catch"](14);
                                    tutor_toast(Ne("Failed", "tutor"), e, "error");
                                case 33:
                                    v.prev = 33;
                ...
                var u = document.getElementById("tutor-checkout-form");
                u === null || u === void 0 ? void 0 : u.addEventListener("submit", (function(e) {
                    e.preventDefault();
                    var a = document.getElementById("tutor-checkout-pay-now-button");
                    a.classList.add("is-loading");
                    a.textContent = Ne("Processing", "tutor");
                    a.setAttribute("disabled", true);
                    this.submit()
                }));
                var s = document.querySelector("[name=billing_country]");
                var l = document.querySelector("[name=billing_state]");
                var h = '<span class="tutor-btn is-loading tutor-checkout-spinner"></span>';
                var y = function e(a, n) {
                    if ("show" === n) {
                        var i;
                        a === null || a === void 0 ? void 0 : a.setAttribute("disabled", "disabled");
                        a === null || a === void 0 ? void 0 : (i = a.closest(".tutor-position-relative")) === null || i === void 0 ? void 0 : i.insertAdjacentHTML("beforeend", h)
                    } else {
                        var t, r;
                        a === null || a === void 0 ? void 0 : a.removeAttribute("disabled");
                        a === null || a === void 0 ? void 0 : (t = a.closest(".tutor-position-relative")) === null || t === void 0 ? void 0 : (r = t.querySelector(".tutor-checkout-spinner")) === null || r === void 0 ? void 0 : r.remove()
                    }
                };
                s === null || s === void 0 ? void 0 : s.addEventListener("change", function() {
                    var e = Te(Re().mark((function e(a) {
                        var t, r, o, d;
                        return Re().wrap((function e(m) {
                            while (1) switch (m.prev = m.next) {
                                case 0:
                                    t = document.querySelector("[name=coupon_code]");
                                    r = a.target.value;
                                    o = t === null || t === void 0 ? void 0 : t.value;
                                    if (!r) {
                                        m.next = 12;
                                        break
                                    }
                ...
                l === null || l === void 0 ? void 0 : l.addEventListener("change", function() {
                    var e = Te(Re().mark((function e(a) {
                        var t, r, o, d, m;
                        return Re().wrap((function e(c) {
                            while (1) switch (c.prev = c.next) {
                                case 0:
                                    t = document.querySelector("[name=coupon_code]");
                                    r = s.value;
                                    o = a.target.value;
                                    d = t === null || t === void 0 ? void 0 : t.value;
                                    if (!o) {
                                        c.next = 14;
                                        break
                                    }
                                    y(a.target, "show");
                                    m = new FormData;
                                    m.set("billing_country", r);
                                    m.set("billing_state", o);
                                    c.next = 11;
                                    return i(m);
                                case 11:
                                    c.next = 13;
        ...
        if (Ie) {
            Ie.addEventListener("change", (function(e) {
                ...
                if (i && i.length > 0) {
                    ...
                    t.innerHTML = '<option value="">'.concat(Ge("N/A", "tutor"), "</option>")
                }
            }))
        }
        ...
        function He(e) {
            for (var a = 1; a < arguments.length; a++) {
                ...
                a % 2 ? Fe(Object(n), !0).forEach((function(a) {
                    Ue(e, a, n[a])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)) : Fe(Object(n)).forEach((function(a) {
        ...
        readyState_complete((function() {
            Object.entries(document.getElementsByTagName("a")).forEach((function(e) {
                var a = e[1].getAttribute("href");
                if (a !== null && a !== void 0 && a.includes("/logout") || a !== null && a !== void 0 && a.includes("logout")) {
                    e[1].setAttribute("data-no-instant", "")
                }
            }))
        }));
        jQuery(document).ready((function(e) {
            ...
            var a = wp.i18n,
                ...
                r = a._nx;
            if (jQuery().select2) {
                e(".tutor_select2").select2({
                    escapeMarkup: function e(a) {
                        return a
                    }
                })
            }
            ...
            ! function(e) {
                function a(e, a) {
                    if (!(e.originalEvent.touches.length > 1)) {
                        ...
                        i.initMouseEvent(a, !0, !0, window, 1, n.screenX, n.screenY, n.clientX, n.clientY, !1, !1, !1, !1, 0, null), e.target.dispatchEvent(i)
                    }
                }
                if (e.support.touch = "ontouchend" in document, e.support.touch) {
                    ...
                    i._touchStart = function(e) {
                        var i = this;
                        !n && i._mouseCapture(e.originalEvent.changedTouches[0]) && (n = !0, i._touchMoved = !1, a(e, "mouseover"), a(e, "mousemove"), a(e, "mousedown"))
                    }, i._touchMove = function(e) {
                        n && (this._touchMoved = !0, a(e, "mousemove"))
                    }, i._touchEnd = function(e) {
                        n && (a(e, "mouseup"), a(e, "mouseout"), this._touchMoved || a(e, "click"), n = !1)
                    }, i._mouseInit = function() {
                        var a = this;
                        a.element.bind({
                            touchstart: e.proxy(a, "_touchStart"),
                            touchmove: e.proxy(a, "_touchMove"),
                            touchend: e.proxy(a, "_touchEnd")
                        }), t.call(a)
            ...
            var o = {
                ...
                played_once: false,
                max_seek_time: 0,
                video_data: function a() {
                    var n = e("#tutor_video_tracking_information").val();
                    return n ? JSON.parse(n) : {}
                },
                track_player: function a() {
                    var i = this;
                    if (typeof Plyr !== "undefined") {
                        var t;
                        var r = i.video_data();
                        var o = new Plyr(this.player_DOM, {
                            keyboard: {
                                focused: i.isRequiredPercentage() ? false : true,
                                global: false
                            },
                            listeners: He({}, i.isRequiredPercentage() && {
                                seek: function e(a) {
                                    var t = i.getTargetTime(o, a);
                                    var r = o.currentTime;
                                    var d = r > i.max_seek_time ? r : i.max_seek_time;
                                    if (t > d) {
                                        a.preventDefault();
                                        tutor_toast(n("Warning", "tutor"), n("Forward seeking is disabled", "tutor"), "error");
                                        return false
                                    }
                                    return true
                                }
                        ...
                        o.on("ready", (function(e) {
                            ...
                            var n = r || {},
                                t = n.best_watch_time,
                                d = t === void 0 ? 0 : t;
                            if (_tutorobject.tutor_pro_url && d > 0) {
                                var m = Math.floor(d);
                                var c = setTimeout((function() {
                                    if (o.playing !== true && o.currentTime !== m) {
                                        if (a.provider === "youtube") {
                                            a.embed.seekTo(d)
                                        } else {
                                            a.media.currentTime = m
                                        }
                                    } else {
                                        clearTimeout(c)
                                    }
                        ...
                        o.on("play", (function(a) {
                            ...
                            if (_tutorobject.tutor_pro_url && o.provider === "youtube") {
                                e(".plyr--youtube.plyr__poster-enabled .plyr__poster").css("opacity", 0)
                            }
                        }));
                        ...
                        o.on("ended", (function(a) {
                            ...
                            i.sync_time(r, d);
                            if (n.autoload_next_course_content && i.played_once) {
                                i.autoload_content()
                            }
                            if (_tutorobject.tutor_pro_url && o.provider === "youtube") {
                                e(".plyr--youtube.plyr__poster-enabled .plyr__poster").css("opacity", 1)
                            }
                        }))
                    }
                },
                sync_time: function a(n, i) {
                    var t = this.video_data();
                    if (!t) {
                        return
                    }
                    if (this.isRequiredPercentage()) {
                        this.enable_complete_lesson_btn(n)
                    }
                    var r = {
                    ...
                    e.post(this.ajaxurl, o);
                    var d = t.best_watch_time > n.currentTime ? t.best_watch_time : n.currentTime;
                    if (d > this.max_seek_time) {
                        this.max_seek_time = d
                    }
                },
                autoload_content: function a() {
                    ...
                    i[this.nonce_key] = _tutorobject[this.nonce_key];
                    e.post(this.ajaxurl, i).done((function(e) {
                        console.log(e);
                        if (e.success && e.data.next_url) {
                            location.href = e.data.next_url
                        }
                    }))
                },
                isRequiredPercentage: function e() {
                    var a = this.video_data();
                    if (!a) {
                        return false
                    }
                    var n = a.strict_mode,
                        i = a.control_video_lesson_completion,
                        t = a.lesson_completed,
                        r = a.is_enrolled;
                    if (_tutorobject.tutor_pro_url && r && !t && n && i) {
                        return true
                    }
                    return false
                },
                enable_complete_lesson_btn: function a(n) {
                    var i = e('button[name="complete_lesson_btn"]');
                    var t = this.video_data();
                    var r = this.getPercentage(Number(n.currentTime), Number(n.duration));
                    if (r >= t.required_percentage) {
                        i.attr("disabled", false);
                        i.next().remove()
                    }
                },
                disable_complete_lesson_btn: function a() {
                    var i = this.video_data();
                    if (!i) {
                        return
                    }
                    var t = i.best_watch_time,
                        r = i.video_duration,
                        o = i.required_percentage;
                    var d = this.getPercentage(Number(t), Number(r));
                    if (d < o) {
                        var m = e('button[name="complete_lesson_btn"]');
                        m.attr("disabled", true);
                        m.wrap('<div class="tooltip-wrap"></div>').after('<span class="tooltip-txt tooltip-bottom">'.concat(Oe(n("Watch at least %s% to complete the lesson.", "tutor"), i.required_percentage), "</span>"))
                    }
                },
                getPercentage: function e(a, n) {
                    if (a > 0 && n > 0) {
                        return Math.round(a / n * 100)
                    }
                    return 0
                },
                getTargetTime: function e(a, n) {
                    if (qe(n) === "object" && (n.type === "input" || n.type === "change")) {
                        return n.target.value / n.target.max * a.media.duration
                    } else {
                        return Number(n)
                    }
                },
            ...
            e(".tutorPlayer").each((function() {
                o.init(this)
            }));
            e(document).on("change keyup paste", ".tutor_user_name", (function() {
                e(this).val(d(e(this).val()))
            }));

            function d(e) {
                return e.toString().toLowerCase().replace(/\s+/g, "-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
            }
            e(document).on("click", ".tutor_question_cancel", (function(a) {
                a.preventDefault();
                e(".tutor-add-question-wrap").toggle()
            }));
            e(".tooltip-btn").on("hover", (function(a) {
                e(this).toggleClass("active")
            }));
            e(".tutor-course-title h4 .toggle-information-icon").on("click", (function(a) {
                e(this).closest(".tutor-topics-in-single-lesson").find(".tutor-topics-summery").slideToggle();
                a.stopPropagation()
            }));
            e(".tutor-course-topic.tutor-active").find(".tutor-course-lessons").slideDown();
            e(".tutor-course-title").on("click", (function() {
                var a = e(this).siblings(".tutor-course-lessons");
                e(this).closest(".tutor-course-topic").toggleClass("tutor-active");
                a.slideToggle()
            }));
            e(document).on("click", ".tutor-topics-title h3 .toggle-information-icon", (function(a) {
                e(this).closest(".tutor-topics-in-single-lesson").find(".tutor-topics-summery").slideToggle();
                a.stopPropagation()
            }));
            e(document).on("click", "[tutor-course-topics-sidebar-toggler]", (function(a) {
                a.preventDefault();
                e(".tutor-course-single-content-wrapper").toggleClass("tutor-course-single-sidebar-hidden")
            }));
            e("[tutor-course-topics-sidebar-offcanvas-toggler]").on("click", (function(a) {
                a.preventDefault();
                e(".tutor-course-single-content-wrapper").toggleClass("tutor-course-single-sidebar-open");
                e("body").toggleClass("tutor-overflow-hidden")
            }));
            e("[tutor-hide-course-single-sidebar]").on("click", (function(a) {
                a.preventDefault();
                console.log("Hello");
                e(".tutor-course-single-content-wrapper").removeClass("tutor-course-single-sidebar-open");
                e("body").removeClass("tutor-overflow-hidden")
            }));
            e(".tutor-tabs-btn-group a").on("click touchstart", (function(a) {
                a.preventDefault();
                var n = e(this);
                var i = n.attr("href");
                e(".tutor-lesson-sidebar-tab-item").hide();
                e(i).show();
                e(".tutor-tabs-btn-group a").removeClass("active");
                n.addClass("active")
            }));
            var m = e(".quiz-draggable-rand-answers").length;
            if (m) {
                e(".quiz-draggable-rand-answers").each((function() {
                    var a = e(this);
                    var n = a.height();
                    a.css({
                        height: n
            ...
            if (jQuery.datepicker) {
                e(".tutor_report_datepicker").datepicker({
                    dateFormat: "yy-mm-dd"
                })
            }
            e(document).on("submit", "#tutor-withdraw-account-set-form", (function(a) {
                if (!a.detail || a.detail == 1) {
                    a.preventDefault();
                    var n = e(this);
                    var i = n.find(".tutor_set_withdraw_account_btn");
                    var t = n.serializeObject();
                    ...
                    e.ajax({
                        ...
                        success: function e(a) {
                            if (a.success) {
                                tutor_toast("Success!", a.data.msg, "success")
                            }
                        },
                        complete: function e() {
                            i.removeClass("is-loading");
            ...
            e(document).on("submit", "#tutor-earning-withdraw-form", (function(a) {
                a.preventDefault();
                var i = e(this);
                var t = e("#tutor-earning-withdraw-btn");
                var r = e(".tutor-withdraw-form-response");
                var o = i.serializeObject();
                e.ajax({
                    url: _tutorobject.ajaxurl,
                    type: "POST",
                    data: o,
                    beforeSend: function e() {
                        i.find(".tutor-success-msg").remove();
                        t.attr("disabled", "disabled").addClass("is-loading")
                    },
                    success: function a(i) {
                        var t;
                        e(".tutor-earning-withdraw-form-wrap").hide();
                        if (i.success) {
                            console.log(i.data.available_balance);
                            if (i.data.available_balance !== "undefined") {
                                e(".withdraw-balance-col .available_balance").html(i.data.available_balance)
                            }
                            tutor_toast(n("Request Successful", "tutor"), n("Your request has been submitted. Please wait for the administrator's response.", "tutor"), "success");
                            setTimeout((function() {
                                location.reload()
                            }), 500)
                        } else {
                            tutor_toast("Error", i.data.msg, "error");
                            t = '<div class="tutor-error-msg inline-image-text is-inline-block">                            <img src="' + window._tutorobject.tutor_url + 'assets/images/icon-cross.svg"/>                             <div>                                <b>Error</b><br/>                                <span>' + i.data.msg + "</span>                            </div>                        </div>";
                            setTimeout((function() {
                                r.html("")
                            }), 5e3);
                            return false
            ...
            e(document).on("click", ".tutor-dashboard-element-delete-btn", (function(a) {
                a.preventDefault();
                var n = e(this).attr("data-id");
                e("#tutor-dashboard-delete-element-id").val(n)
            }));
            e(document).on("submit", "#tutor-dashboard-delete-element-form", (function(a) {
                a.preventDefault();
                var n = e("#tutor-dashboard-delete-element-id").val();
                var i = e(".tutor-modal-element-delete-btn");
                var t = e(this).serializeObject();
                e.ajax({
                    url: _tutorobject.ajaxurl,
                    type: "POST",
                    data: t,
                    ...
                    success: function a(i) {
                        if (i.success) {
                            e("#tutor-dashboard-" + i.data.element + "-" + n).remove()
                        }
                    },
                    complete: function e() {
                        i.removeClass("is-loading")
            ...
            e(document).on("submit", "#tutor_assignment_start_form", (function(a) {
                a.preventDefault();
                var n = e(this);
                var i = n.serializeObject();
                i.action = "tutor_start_assignment";
                e.ajax({
                    url: _tutorobject.ajaxurl,
                    type: "POST",
                    data: i,
                    beforeSend: function a() {
                        e("#tutor_assignment_start_btn").addClass("is-loading")
                    },
                    success: function e(a) {
                        if (a.success) {
                            location.reload(true)
                    ...
                    error: function e(a, n, i) {
                        console.log("assignment start error: " + i)
                    },
                    complete: function a() {
                        e("#tutor_assignment_start_btn").removeClass("is-loading")
                    }
                })
            }));
            e(document).on("submit", "#tutor_assignment_submit_form", (function(e) {
                var a = tinymce.activeEditor.getContent();
                if (a.trim().length < 1) {
                    e.preventDefault();
                    tutor_toast(n("Warning", "tutor"), n("Assignment answer is required.", "tutor"), "error");
                    setTimeout((function() {
                        jQuery("button#tutor_assignment_submit_btn").removeClass("is-loading").removeAttr("disabled")
                    }), 500)
                }
            }));
            e("form").on("change", ".tutor-assignment-file-upload", (function() {
                e(this).siblings("label").find("span").html(e(this).val().replace(/.*(\/|\\)/, ""))
            }));
            if (e(".tutor-accordion-item-header.is-active").length === 0) {
                e(".tutor-accordion-item-header").first().trigger("click")
            }
            e(".tutor-course-builder-section-title").on("click", (function() {
                if (e(this).find("i").hasClass("tutor-icon-angle-up")) {
                    e(this).find("i").removeClass("tutor-icon-angle-up").addClass("tutor-icon-angle-down")
                } else {
                    e(this).find("i").removeClass("tutor-icon-angle-down").addClass("tutor-icon-angle-up")
                }
                e(this).next("div").slideToggle()
            }));
            e(document).on("click", "#tutor_profile_photo_button", (function(a) {
                a.preventDefault();
                e("#tutor_profile_photo_file").trigger("click")
            }));
            e(document).on("change", "#tutor_profile_photo_file", (function(a) {
                a.preventDefault();
                var n = this;
                if (n.files && n.files[0]) {
                    var i = new FileReader;
                    i.onload = function(a) {
                        e(".tutor-profile-photo-upload-wrap").find("img").attr("src", a.target.result)
                    };
                    i.readAsDataURL(n.files[0])
                }
            }));
            e(document).on("click", ".thread-content .subject", (function(a) {
                var n = e(this);
                var i = parseInt(n.closest(".thread-content").attr("data-thread-id"));
                var t = _tutorobject.nonce_key;
                var r = {
                    thread_id: i,
                ...
                e.ajax({
                    ...
                    data: r,
                    beforeSend: function a() {
                        e("#tutor-bp-thread-wrap").html("")
                    },
                    success: function a(n) {
                        if (n.success) {
                            e("#tutor-bp-thread-wrap").html(n.data.thread_head_html);
                            c()
                        }
                    }
                })
            ...
            function c() {
                e("ul.tutor-bp-enrolled-course-list").each((function() {
                    var a = e(this);
                    var n = a.find(" > li");
                    var i = 3;
                    if (n.length > i) {
                        ...
                        var r = '<a href="javascript:;" class="tutor_bp_plus_courses"><strong>+' + t + " More </strong></a> Courses";
                        a.closest(".tutor-bp-enrolled-courses-wrap").find(".thread-participant-enrolled-info").html(r)
                    }
                    a.show()
                }))
            }
            c();
            e(document).on("click", "a.tutor_bp_plus_courses", (function(a) {
                a.preventDefault();
                var n = e(this);
                n.closest(".tutor-bp-enrolled-courses-wrap").find(".tutor-bp-enrolled-course-list li").show();
                n.closest(".thread-participant-enrolled-info").html("")
            }));
            e(".tutor-dropbtn").click((function() {
                var a = e(this).parent().find(".tutor-dropdown-content");
                a.slideToggle(100)
            }));
            e(document).on("click", (function(a) {
                var n = e(".tutor-dropdown");
                var i = n.find(".tutor-dropdown-content");
                if (!n.is(a.target) && n.has(a.target).length === 0) {
                    i.slideUp(100)
                }
            }));
            var u = e('.tutor-frontend-builder-course-price [name="tutor_course_price_type"]');
            if (u.length == 0) {
                e("#_tutor_is_course_public_meta_checkbox").show()
            } else {
                u.change((function() {
                    if (e(this).prop("checked")) {
                        var a = e(this).val() == "paid" ? "hide" : "show";
                        e("#_tutor_is_course_public_meta_checkbox")[a]()
                    }
                })).trigger("change")
            }(function(e) {
                e.fn.tutor_tooltip = function() {
                    this.on("mouseenter click", ".tooltip", (function(a) {
                        a.stopPropagation();
                        e(this).removeClass("isVisible")
                    })).on("mouseenter focus", ":has(>.tooltip)", (function(a) {
                        if (!e(this).prop("disabled")) {
                            e(this).find(".tooltip").addClass("isVisible")
                        }
                    })).on("mouseleave blur keydown", ":has(>.tooltip)", (function(a) {
                        if (a.type === "keydown") {
                            if (a.which === 27) {
            ...
            jQuery(".tutor-static-loader").click((function() {
                var e = this;
                setTimeout((function() {
                    jQuery(e).addClass("is-loading").attr("disabled", "disabled")
                }), 100)
            }));
            ...
            jQuery('#tutor-registration-form [name="password_confirmation"]').on("input", (function() {
                var e = jQuery('[name="password"]');
                var a = (e.val() || "").trim();
                var n = a && jQuery(this).val() === a;
                jQuery(this).parent().find(".tutor-validation-icon")[n ? "show" : "hide"]()
            }))
        }))
    })()
})();